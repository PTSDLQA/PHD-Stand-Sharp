...
namespace OWASP.WebGoat.NET.App_Code.DB
{
    public class DbConstants
    {
        ...
        //DB Scripts
        public const string DB_CREATE_SCRIPT = @"D:\AI\Apps\Sharp\webgoat.net\WebGoat\DB_Scripts\create_webgoatcoins.sql";
        public const string DB_LOAD_MYSQL_SCRIPT = @"D:\AI\Apps\Sharp\webgoat.net\WebGoat\DB_Scripts\load_webgoatcoins.sql";
        public const string DB_LOAD_SQLITE_SCRIPT = @"D:\AI\Apps\Sharp\webgoat.net\WebGoat\DB_Scripts\load_webgoatcoins_sqlite3.sql";
    }
}
